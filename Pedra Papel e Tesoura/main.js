...
function jogar(escolha) {
    ...
    if (ganhador == 0) {
        ...
        document.getElementById('mensagem').innerHTML = "BOA GUERREIRO(A)";
        jogadorPontos++;
    } else if (ganhador == 2) {
        document.getElementById('mensagem').innerHTML = "A MAQUINA GANHOU";
        computadorPontos++;
    }

    document.getElementById('jogadorPontos').innerHTML = jogadorPontos;
    document.getElementById('computadorPontos').
    innerHTML = computadorPontos;
